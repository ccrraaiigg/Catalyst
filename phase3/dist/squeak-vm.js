...
class SqueakVM {
    ...
    createMockVM() {
        // Create a mock VM for demonstration when WASM loading fails
        console.warn('Creating mock VM for demonstration purposes');
        ...
        this.compiler = {
            ...
            clearCache: () => { this.compiledMethodCache.clear(); },
            getCacheSize: () => this.compiledMethodCache.size
        };
    }
